...
const ui = {
  ...
  pt: {
    ...
    'craft.intro':
      'Estudos em motion e sensação de UI — o tipo de detalhe que me importa em produtos reais. Sem dependências, view-source friendly.',
    'craft.viewSource': 'Ver código',
    'til.eyebrow': 'TIL',
